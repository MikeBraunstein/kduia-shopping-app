        ...
        <div className='row'>
            ...
            <div className="input-group mb-3" style={{ marginLeft: '2rem'}}>
                ...
                <label className="input-group-text" htmlFor="inputGroupSelect01">Items</label>
                  ...
                  <select className="custom-select" id="inputGroupSelect01" onCharge={(event) => setName(event.target.value)}>
                ...
                <label className="input-group-text" htmlFor="inputGroupSelect02">Quantity</label>
                  ...
                  <select className="custom-select" id="inputGroupSelect02" onChange={(event) => setAction(even.target.value)}>
